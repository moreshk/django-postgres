    ...
    if request.method == 'GET':
        ...
        try:
            ...
            prompt_template = (
                ...
                "continue your train of thought. Do not provide 'Continue' as an option if your message is asking a question and a specific response is expected from the user."
