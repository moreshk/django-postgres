...
def generate_test_data(exam_type, essay_type, grade):
    ...
    naplan_pesuasive_template = """You are a test task creator for {test_type}. I will provide you the test type and your job is to create a task for a test taker.
