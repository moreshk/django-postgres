...
def create_lessons_old(course, lessons_data):
    print("I am in create lessons")
...
class TranscribeView(View):
    ...
    # Placeholder logic
        ...
        course_splitter_prompt = PromptTemplate(
            ...
            You will analyze the text and break it down into logical components of four to six sentences each so that only one or two concepts max are discussed in each of them. 
            ...
            It is important that your json does not skip or lose any parts of the transcript when it breaks it down into the dialog components.
    """,
        )
        ...
        lessons = split_lessons.get('data', split_lessons.get('parts', []))
